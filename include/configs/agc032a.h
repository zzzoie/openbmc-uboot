...
#ifdef CONFIG_SPL
#define CONFIG_BOOTARGS          "debug console=ttyS4,115200n8 root=/dev/ram rw printk.time=1 dual_flash=2"
#else
#define CONFIG_BOOTARGS          "debug console=ttyS4,115200n8 root=/dev/ram rw printk.time=1"
#endif
